...
cookbook 'hops', github: "steffengr/hops-hadoop-chef", branch: "change_hadoop_home_rights"
...
cookbook 'kube-hops', github: "steffengr/kube-hops-chef", branch: "jupyter_kube"
